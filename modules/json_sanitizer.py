...
# ---------------------------------------------------------------------
# PiKit opinionated defaults
# ---------------------------------------------------------------------

def get_pikit_sanitize_options() -> SanitizeOptions:
    """
    Defaults tuned for PiKit/DemoKit:
    - Friendly bullets
    - Stable ordering
...
PIKIT_SANITIZE_OPTS = get_pikit_sanitize_options()
